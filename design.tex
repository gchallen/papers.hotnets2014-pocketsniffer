...
To support both network monitoring and debugging on long timescales and
adaptation on short timescales, \PS{} uses both synchronous and asynchronous
...
queries are initiated programmatically by APs, short-lived, and satisfied
